...
const searchPageNum = localStorage.getItem('searchPageNum')
const searchPage = searchPageNum === null ? 1 : JSON.parse(searchPageNum)

// const searchText = localStorage.getItem('searchText')
// const searchedText = searchText === null ? '' : searchText
